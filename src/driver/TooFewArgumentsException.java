...
/**
 * Custom exception that is raised when a user enters too few arguments for a
 * command.
 */
public class TooFewArgumentsException extends RuntimeException {
   ...
   */
  public TooFewArgumentsException(String commandName) {
  ...
  public String getMessage() {
    return this.commandName + ": missing operand(s)\nTry 'man "
